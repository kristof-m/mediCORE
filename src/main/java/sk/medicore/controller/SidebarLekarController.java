...
public class SidebarLekarController {
    ...
    @FXML private Button navMojiPacienti;
    ...
    private static final String IC_CLOCK     = "M12 2a10 10 0 1 1 0 20 10 10 0 0 1 0-20Z M12 6v6l4 2";
    private static final String IC_PATIENTS  = "M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2 M9 3a4 4 0 1 1 0 8 4 4 0 0 1 0-8Z M23 21v-2a4 4 0 0 0-3-3.87 M16 3.13a4 4 0 0 1 0 7.75";
    ...
    public void initialize() {
        ...
        navTerminy.setGraphic(makeIcon(IC_CLOCK, "#555"));       navTerminy.setGraphicTextGap(8);
        navMojiPacienti.setGraphic(makeIcon(IC_PATIENTS, "#555")); navMojiPacienti.setGraphicTextGap(8);
    ...
    public void setActivePage(String page) {
        ...
        setBtn(navTerminy, "terminy".equals(page));
        setBtn(navMojiPacienti, "pacienti".equals(page));
    ...
    @FXML private void handleNavTerminy()   { navigate("/view/lekar-dostupnost.fxml"); }

    @FXML private void handleNavMojiPacienti() { navigate("/view/lekar-pacienti.fxml"); }
    @FXML private void handleNavLekarProfil()  { navigate("/view/lekar-profil.fxml"); }

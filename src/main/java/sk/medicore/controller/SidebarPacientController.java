...
public class SidebarPacientController {
    ...
    private static final String IC_PLUS      = "M12 2a10 10 0 1 1 0 20 10 10 0 0 1 0-20Z M12 8v8 M8 12h8";
    private static final String IC_CAL2      = "M5 4h14a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2Z M8 2v4 M16 2v4 M3 10h18";
    ...
    public void initialize() {
        ...
        navRezervacje.setGraphic(makeIcon(IC_CALENDAR, "#555")); navRezervacje.setGraphicTextGap(8);
        navRezervovat.setGraphic(makeIcon(IC_PLUS, "#555"));    navRezervovat.setGraphicTextGap(8);
        navKalendar.setGraphic(makeIcon(IC_CAL2, "#555"));       navKalendar.setGraphicTextGap(8);
    ...
    public void setActivePage(String page) {
        ...
        setBtn(navRezervacje, "rezervacje".equals(page));
        setBtn(navRezervovat, "rezervovat".equals(page));
